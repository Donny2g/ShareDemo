...
- (void)authorizeWithTargetViewController:(UIViewController *)targetViewController scope:(NSString*)scope andDelegate:(id<BaiduAuthorizeDelegate>)delegate
{
    ...
    authController.isShowRegisterPage = NO;
    ...
    if ([NSClassFromString(@"UIViewController") instancesRespondToSelector:@selector(presentViewController:animated:completion:)]) {
        ...
        [targetViewController presentViewController:authController animated:YES completion:nil];
    }
...
- (void)registerWithTargetViewController:(UIViewController *)targetViewController scope:(NSString*)scope andDelegate:(id<BaiduAuthorizeDelegate>)delegate
{
    ...
    authController.delegate = delegate;
    authController.scope = scope;
    authController.isShowRegisterPage = YES;
